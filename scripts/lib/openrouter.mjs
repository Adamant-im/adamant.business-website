...
export async function callOpenRouter(prompt, { temperature, maxTokens, system } = {}) {
    ...
    try {
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        headers: {
          ...
          'X-Title': 'cryptofoundry content translation',
        },
        body: JSON.stringify({
          model,
  ...
  throw new Error(`All OpenRouter models failed: ${models.join(', ')}`);
}
